        ...
        <div id='projects'>
            ...
            <div className='w-[80%] md:w-[60%] mx-auto flex items-center justify-center flex-col space-y-10 md:space-y-20 my-10 md:my-20'>
                ...
                <div className='flex gap-10 lg:gap-20 items-center flex-col lg:flex-row lg:flex-row-reverse'>
                    ...
                    <div className='flex-1 shadow-xl hidden lg:block image-desktop jobs'>
                        {/* <img src={jobs} alt="" /> */}
                    </div>
                    <div className='flex-1 space-y-5'>
                        <h2 className='text-2xl font-bold text-purple-300 text-center'>Flex Jobs</h2>
                        <p className='text-center'>Front-end projects with different types of application-specific jobs are available.</p>
                        <div className='flex'>
                            <p className='font-bold'>Technologies: </p>
                            <p>React JS | React Router | React Bootstrap</p>
                        </div>
                        <div className='flex justify-center gap-x-2 md:gap-x-5 social-links font-bold'>
                            <a href="https://github.com/nusratneela27/flex-jobs" target='_blank' className='flex items-center gap-x-2'>Client
                                <FaGithub />
                            </a>
                            <a href="https://rococo-elf-4039fd.netlify.app/" target='_blank' className='flex items-center gap-x-2'>Live Site <FaRegArrowAltCircleRight />
                            </a>
                        </div>
                    </div>
                </div>
