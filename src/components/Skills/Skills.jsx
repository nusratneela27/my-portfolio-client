...
const Skills = () => {
  ...
  return (
    <div id="skills" className="mb-20 mt-20">
      <h1 className="text-3xl text-center mt-16 mb-6 font-bold text-purple-300">
        My Skills
      </h1>

      <div
        className="grid grid-cols-2 lg:grid-cols-5 gap-10 px-16 md:px-40"
        data-aos="fade-up"
      ...
      >
        <div className="items-center rounded shadow-xl p-4">
          <img
            src={html5}
            title="html5"
            className="w-5 h-5 lg:w-[35px] lg:h-[35px] mb-3"
          />
